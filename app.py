...
if st.button("🔍 Predict"):
    ...
    ax.legend()
    ast.markdown("<p style='text-align: center;'>🚀 Built with Streamlit | ML Project</p>", unsafe_allow_html=True)'text-align: center;'>🚀 Built with Streamlit | ML Project</p>", unsafe_allow_html=True)t-align: center;'>Made with ❤️ using Streamlit</p>", unsafe_allow_html=True)   