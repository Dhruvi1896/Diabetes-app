...
# Footer
st.markdown("---")
st.markdown("<p style='text-align: center;'>🚀 Built with Streamlit | ML Project</p>", unsafe_allow_html=True)t-align: center;'>Made with ❤️ using Streamlit</p>", unsafe_allow_html=True)   